...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\saanc\\OneDrive\\Desktop\\COURSES AU\\MAJOR\\MAJOR CORE\\Lab In Psychology\\PsychoPy Experiments\\Adaptive_Staircase\\Adaptive_Staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Welcome to the Adaptive Staircase Procedure\n\nInstructions:\nThere will be a grating graphic displayed on your screen. Determine and respond the direction of the tilt. \nFor a rightward tilt, press the "right arrow key"\nFor a leftward tilt, press the "left arrow key"',
        font='Arial',
    ...
    Fixation = visual.ShapeStim(
        win=win, name='Fixation', vertices='star7',
        size=(0.5, 0.5),
